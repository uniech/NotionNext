...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个孩子对满天星的执念', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'unie.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'design, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'uniechen@iCloud.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'font-serif font-Regular',
  // 字体CSS 例如 https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css
  FONT_URL: [
    // 'https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css',
    'https://fonts.googleapis.com/css2?family=Libre+Caslon+Display&family=Libre+Caslon+Text:ital,wght@0,400;0,700;1,400&display=swap' rel='stylesheet',
  ...
  MOUSE_FOLLOW_EFFECT_COLOR: '#4a2be0', // 鼠标点击特效颜色 #xxxxxx 或者 rgba(r,g,b,a)
